...
import ru.vsu.map.RBTree;
import ru.vsu.map.SimpleRedBlackTree;

import java.util.*;

public class SimpleTreeMap<Key extends Comparable<Key>, Value> implements Map<Key,Value> {

    static class MapTreeEntry<Key extends Comparable<? super Key>, Value> implements Entry<Key, Value>, Comparable<MapTreeEntry<Key, Value>> {
    ...
    public Set<Key> keySet() {
        return new HashSet<>() {
            final Iterator<Entry<Key, Value>> entryIterator = entrySet().iterator();
